...
<body>
	...
	<%-- 
		...
		session		: sessio 이 만료되기 전까지 유효한 속성
					(세션이 만료되는 시점 : server 종료시 / tomcat 설정에 따라 / session.invalidate()
					/ 사용자가 server timeout 시간안에 요청을 하지 않았을때)
		application	: was 에 하나존재(서버 종료 전까지는 유효)
	--%>
	<%
